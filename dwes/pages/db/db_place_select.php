<?php include ($_SERVER['DOCUMENT_ROOT'].'/student067/dwes/header.php');?>
    ...
    <main class="flex flex-row flex-wrap">
        ...
        <div class="my-8 max-w-md mx-auto bg-white p-6 rounded-lg shadow-md m-4 shadow-gray-700  hover:scale-110 w-96">
            ...
            <p ><span class="font-bold">Place ID:</span> <?php echo $customer[$i]['customer_id'];?></p>
            <p><span class="font-bold">Place Type: </span> <?php echo $customer[$i]['forename'];?> </p> 
            <p><span class="font-bold">Place Capacity: </span>  <?php echo $customer[$i]['lastname'];?> </p>
            <p><span class="font-bold"> Place Price : </span> <?php echo $customer[$i]['username'];?> </p>
