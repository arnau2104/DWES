<?php include ($_SERVER['DOCUMENT_ROOT'].'/student067/dwes/header.php');?>
  ...
  <main class="container mx-auto py-8">
    <div class="max-w-md mx-auto bg-white p-6 rounded-lg shadow-md">
      ...
      <form action="/student067/dwes/pages/db/bd_customer_select.php" method="POST">
        <div class="mb-4">
          <label for="name" class="block text-gray-700 font-bold mb-2">Room ID</label>
          <input type="number"  name="place_id" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring focus:ring-blue-500" placeholder="Select a Customer ID">
