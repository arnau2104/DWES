    ...
    <div class="max-w-md mx-auto bg-white p-6 rounded-lg shadow-md">
      ...
      <form action="/student067/dwes/pages/forms/form_customer_update.php" method="POST">
        <div class="mb-4">
          ...
          <input type="number"  name="user_id" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring focus:ring-blue-500" placeholder="Select a Customer ID to update" required>
