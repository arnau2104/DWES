    ...
    <div class="my-8 max-w-md mx-auto bg-white p-6 rounded-lg shadow-md m-4 shadow-gray-700  hover:scale-110 w-96">
        ...
        <p><span class="font-bold">Reservation State: </span> <?php echo $reservation[$i]['reservation_state']; ?> </p>
            <form action="/student067/dwes/pages/forms/form_reservation_update.php" method="POST">
                ...
                <button type="submit" name="submit" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors duration-200">Update</button>
            </form>
    </div>
    ...
    <div class="max-w-md mx-auto bg-white p-6 rounded-lg shadow-md">
      ...
      <form action="/student067/dwes/pages/forms/form_reservation_update.php" method="POST">
        <div class="mb-4">
          ...
          <input type="number"  name="reservation_id" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring focus:ring-blue-500" reservationholder="Select a reservation ID to update">
