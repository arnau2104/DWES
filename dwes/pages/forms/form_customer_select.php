<?php include ($_SERVER['DOCUMENT_ROOT'].'/student067/dwes/header.php');?>
  ...
  <main class="container mx-auto py-8">
    <div class="max-w-md mx-auto bg-white p-6 rounded-lg shadow-md">
      ...
      <form action="/student067/dwes/pages/bd/bd_customer_select.php" method="POST">
        <div class="mb-4">
          <label for="name" class="block text-gray-700 font-bold mb-2">Customer ID</label>
          <input type="number"  name="customer_id" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring focus:ring-blue-500" placeholder="Select a Customer ID">
      ...
      <button class="bg-blue-600 rounded text-white h-10 w-48">Show all the customers</button>
    </div>
  </main>
