    ...
    <div class="container mx-auto flex justify-between items-center">
      ...
      <nav>
        <ul class="flex space-x-4">
          ...
          <li><p class="text-white hover:text-gray-300">Customers</p><ul class="displayed-menu hidden">
          ...
          <li><a href="#" class="text-white hover:text-gray-300">Rooms</a></li><ul class="displayed-menu hidden">
          ...
          <li><a href="#" class="text-white hover:text-gray-300">Reservations</a></li><ul class="displayed-menu hidden>">
