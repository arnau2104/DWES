    ...
    <div class="max-w-md mx-auto bg-white p-6 rounded-lg shadow-md">
      ...
      <form action="../bd/bd_select_customer.php" method="POST">
        <div class="mb-4">
          ...
          <input type="number"  name="customer_id" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring focus:ring-blue-500" placeholder="Your forename">
        </div>
